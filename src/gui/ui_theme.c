...
static void bar_init(void)
{
	...
	bar_bg.body.radius = LV_DPI / 10;// LV_RADIUS_CIRCLE;
	...
	bar_indic.body.radius = LV_DPI / 10;// LV_RADIUS_CIRCLE;
...
static void slider_init(void)
{
	...
	slider_knob.body.radius = LV_DPI / 10;// LV_RADIUS_CIRCLE;
...
static void ta_init(void)
{
	...
	theme.style.ta.area->body.radius = LV_DPI / 20;
#endif
}
...
static void list_init(void)
{
	...
	list_bg.body.radius = LV_DPI / 20;
//	list_bg.body.opa = LV_OPA_TRANSP;
//	list_bg.body.border.width = 0;
    ...
    list_btn_rel.body.radius         = LV_DPI / 20;
...
static void ddlist_init(void)
{
    ...
    ddlist_bg.body.radius         = LV_DPI / 10;
